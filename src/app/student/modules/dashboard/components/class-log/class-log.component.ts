...
@Component({
  selector: 'app-class-log',
  templateUrl: './class-log.component.html',
  styleUrls: ['./class-log.component.css']
})
export class ClassLogComponent implements OnInit {
  events = [];
  listingEvents = [];
  classes = [];
  ...
  openPopup(content) {
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title', windowClass: 'custom-class', size: 'lg', centered: true });
  }
